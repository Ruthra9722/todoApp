...
function App() {
    ...
    async function postreg(){
        axios.post(' https://todo--12345.herokuapp.com/api/user/register',{
  ...
  return (
    <MDBContainer fluid>
      ...
      <MDBCard className='text-black m-5' style={{borderRadius: '25px'}}>
        ...
        <input id='name' name='name' type='text'placeholder='enter Name' onChange={formik.handleChange} value={formik.values.name}></input><br></br><br></br>
        
        <input id="uname" name="uname" type="text" placeholder='enter Uset Name' onChange={formik.handleChange}
        ...
        onChange={formik.handleChange} value={formik.values.password} /><br></br><br></br>
